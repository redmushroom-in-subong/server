...
public class AddReviewRequestTest {

    private static final Validator validator = Validation.buildDefaultValidatorFactory().getValidator();

    @Test
    public void AddReviewRequest_NotBlank_체크() {
        //given
        ...
        AddReviewRequest request = AddReviewRequest.testBuilder()
                ...
                .build();
        //when
        Set<ConstraintViolation<AddReviewRequest>> violations = validator.validate(request);
